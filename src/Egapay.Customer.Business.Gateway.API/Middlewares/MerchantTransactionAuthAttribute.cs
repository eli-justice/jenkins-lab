...
public class MerchantTransactionAuthentication : TypeFilterAttribute
{
    public MerchantTransactionAuthentication() 
        : base(typeof(MerchantTransactionAuthenticationFilter))
    {
    }
}
public class MerchantTransactionAuthenticationFilter: EganowControllerBase,IAsyncActionFilter
{
    private readonly ILogger<MerchantTransactionAuthenticationFilter> _logger;
    
    public MerchantTransactionAuthenticationFilter(ILogger<MerchantTransactionAuthenticationFilter> logger)
    {
        _logger = logger;
    }
