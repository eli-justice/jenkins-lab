...
public class GenerateOtpRequestValidator:ValidatorBase<GenerateOtpRequest>
{
    public GenerateOtpRequestValidator(IStringLocalizer<ValidationMessages> localizer)
    {
        RuleFor(x=>x.Email).
